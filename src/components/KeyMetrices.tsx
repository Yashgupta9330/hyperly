...
export default function KeyMetrics({ analyticsData }: KeyMetricsProps) {
  const { numProfileViews, numSearchAppearances, numConnections } = analyticsData;
        ...
        <div className="flex w-full gap-2">
          <Card className="bg-[#f4f4ff] p-4 w-1/2">
            <CardContent>
              ...
              <div className="text-4xl font-bold">{numConnections}</div>
          ...
          <Card className="bg-[#f4f4ff] p-4 w-1/2">
            <CardContent>
              ...
              <div className="text-4xl font-bold">{numSearchAppearances}</div>
        ...
        <div className="flex gap-2">
          ...
          <Card className="bg-white p-4 w-1/2">
            <CardContent>
              ...
              <div className="text-4xl font-bold">{numProfileViews}</div>
